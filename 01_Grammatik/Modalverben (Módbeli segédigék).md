---
Titel: Modalverben (Módbeli segédigék)
tags:
  - Grammatik
Wortschatz: "[[Modalverben]]"
---
# Modalverben (Módbeli segédigék)

## Alapszabály

A módbeli segédigék megváltoztatják a mondat értelmét (képességet, akaratot, kényszert fejeznek ki). Két dologban térnek el a többi igétől:
1. **Ragozás:** Egyes szám 1. és 3. személyben **nincs rag**, és a tőhangzó gyakran megváltozik.
2. **Mondatszerkezet:** A módbeli segédige áll a 2. helyen (ragozva), a főige pedig a mondat **legvégére** kerül **főnévi igenévi** (_Infinitiv_) alakban.
...
\* A **möchte** technikailag a mögen alakja, de a gyakorlatban önálló segédigeként kezeljük.

> [!TIP] **Figyeld meg:** Az **ich** és az **er/sie/es** alakok mindig megegyeznek!
