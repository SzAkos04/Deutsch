...
- _Ich habe **keine** Kinder._ (Nincsenek gyerekeim - többes szám)
...
- wir → **unser-**
- ihr → **euer-**
  Ha az **euer** szó végződést kap, a szótő utolsó **-e-** betűje kiesik!
	- _euer_ + _e_ → **eure**
	- _euer_ + _en_ → **euren**
...
- _Ich liebe **meinen** Vater._ (Akkusativ, Maskulin → **-en**)
- _Ich helfe **meiner** Mutter._ (Dativ, Feminin → **-er**)
...
- **Feminin:** _diese_ (Nom.), _diese_ (Akk.), _dieser_ (Dat.)
- **Neutrum:** _dieses_ (Nom.), _dieses_ (Akk.), _diesem_ (Dat.)