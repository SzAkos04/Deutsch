...
> [!INFO] Szabály
> 
> Tőhangváltás csak egyes szám 2. és 3. személyben van!

| Alany               | [[fahren]]    | [[essen]]    | [[nehmen]]    | [[sprechen]]    | [[sehen]]     |
| ------------------- | ------------- | ------------ | ------------- | --------------- | ------------- |
| **ich**             | fahre         | esse         | nehme         | spreche         | sehe          |
| **du**              | f**ä**hrst    | **i**sst     | n**i**mmst    | spr**i**chst    | s**ie**hst    |
| **er<br>sie<br>es** | <br>f**ä**hrt | <br>**i**sst | <br>n**i**mmt | <br>spr**i**cht | <br>s**ie**ht |
| **wir**             | fahren        | essen        | nehmen        | sprechen        | sehen         |
...
| **er<br>sie<br>es** | <br>muss   | <br>kann   | <br>will   | <br>darf   | <br>soll   | <br>mag   |
...
> [!INFO] Jó tudni
> 
> A módbeli segédigék rendhagyó ragozásához hasonló a _**[[wissen]]**_ (tudni) ige ragozása is.
> 
> weiß, weißt, weiß
> wissen, wisst, wissen
...
- **Beszédben:** A _haben_, _sein_, _werden_, ill. a módbeli segédigék esetében
...
| Alany               | Rag                          |
| ------------------- | ---------------------------- |
| **ich**             | -te (pl. _[[sagen\|sagte]]_) |
| **du**              | -test (pl. _sagtest_)        |
| **er<br>sie<br>es** | <br>-te (pl. _sagte_)        |
| **wir**             | -ten (pl. _sagten_)          |
| **ihr**             | -tet (pl. _sagtet_)          |
...
| ------------------- | ------------- | --------- | --------- |
| **ich**             | schrieb       | ging      | aß        |
| **du**              | schriebst     | gingst    | aßt       |
| **er<br>sie<br>es** | <br>schrieb   | <br>ging  | <br>aß    |
| **wir**             | schrieben     | gingen    | aßen      |
...
| **er<br>sie<br>es** | <br>dachte | <br>brachte | <br>kannte |
| **wir**             | dachten    | brachten    | kannten    |
...
| **er<br>sie<br>es** | <br>hatte | <br>war  | <br>wurde  |
...
| Alany               | müssen     | können     | wollen     | dürfen     | sollen     | mögen      |
| ------------------- | ---------- | ---------- | ---------- | ---------- | ---------- | ---------- |
| **ich**             | musste     | konnte     | wollte     | durfte     | sollte     | mochte     |
| **du**              | musstest   | konntest   | wolltest   | durftest   | solltest   | mochtest   |
| **er<br>sie<br>es** | <br>musste | <br>konnte | <br>wollte | <br>durfte | <br>sollte | <br>mochte |
| **wir**             | mussten    | konnten    | wollten    | durften    | sollten    | mochten    |
| **ihr**             | musstet    | konntet    | wolltet    | durftet    | solltet    | mochtet    |
| **sie, Sie**        | mussten    | konnten    | wollten    | durften    | sollten    | mochten    |
